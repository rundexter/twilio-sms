    ...
    , data: {
        local_test_step: {
            ...
            input: {
                ...
                phone: '2404189814'
                , message: 'abcdefghijklmnopqrstuvxyzabcdefghijklmnopqrstuvxyzabcdefghijklmnopqrstuvxyzabcdefghijklmnopqrstuvxyzabcdefghijklmnopqrstuvxyzabcdefghijklmnopqrstuvxyz'
                , mediaUrl: 'http://cdn.justbaustralia.com.au/wp-content/uploads/2012/05/Lionel_Richie_Hello_Lost_Sign_1.jpg'
                , from: '+14433398376'
            }
        }
    }
